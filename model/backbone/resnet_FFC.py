...
class FFCResnetBlock(nn.Module):
    def __init__(self, dim = 32 * 16, padding_type = 'reflect', norm_layer = nn.BatchNorm2d, activation_layer=nn.ReLU, dilation=1,
                 inline=False, outline=False,pretrained ='False',**conv_kwargs):
        super().__init__()
...
class resnet_FFC(nn.Module):
    def __init__(self, 
                base_dim=32,
                n_blocks=7,pretrained = False):
        super(resnet_FFC, self).__init__()
        self.layer1 = resnet101(pretrained)
